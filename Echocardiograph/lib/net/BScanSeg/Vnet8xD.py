...
class OutputTransition(nn.Module):
    ...
    def __init__(self, inChans, elu, nll, out_channel):
        ...
        self.conv1 = nn.Conv3d(inChans, out_channel, kernel_size=3, padding=1)
...
class VNet(nn.Module):
    ...
    def __init__(self, elu=True, nll=False, out_channel=2):
        ...
        self.up_tr128 = UpTransition(256, 128, 2, elu, dropout=True)  # 2 layers in 256 out 256 size=input_X/2
...
if __name__ == '__main__':
    ...
    summary(test_net, (1, 160, 160, 160), batch_size=1)  # channel/ depth / width / height
