"""
    ...
    made up to adjust the lr_scheduler type !!!!!
    can be adjust later

"""
from torch.optim.lr_scheduler import MultiStepLR
from collections import Counter
from lib.optimizer.lr_scheduler import WarmupMultiStepLR, ManualStepLR
...
def make_lr_scheduler(cfg, optimizer):
    if cfg.train.warmup:
        ...
        scheduler = ManualStepLR(optimizer, milestones=cfg.train.milestones, gammas=cfg.train.gamma)
    else:
