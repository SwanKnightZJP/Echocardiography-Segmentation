...
if __name__ == '__main__':
    ...
    # img_folder = '/media/zdc/zjp/datasets/data_Bscan/nii_files/V5/pred/test_IMG/'
    img_folder = 'C:\\Users\\mnrsm\\Downloads\\NRRD\\zhuqiyuASD\\'

    label_folder = '/media/zdc/zjp/datasets/data_Bscan/nii_files/V5/pred/test_LABEL/'
    save_floder = '/media/zdc/zjp/datasets/data_Bscan/nii_files/V5/pred/ORI_CAT_x8/'

    # img_name = 'IMG_036.nii.gz'
    img_name = 'Seq_03_002_zhuqiyuASD.seq.nrrd'  #

    label_name = img_name.replace('IMG_', 'LABEL_') if img_name.split('_')[0] == 'IMG' else ''

    img_pth, label_pth = img_folder + img_name, label_folder + label_name

    # save_pth = save_floder + img_name.replace('IMG', 'Predict_GDCE_3549')
    save_pth = img_folder + img_name.replace('Seq_', 'Pred_Seq_9_')
